...
#implementation of Pan-Tomkins algorithm for R-peak detection

ecg = pd.read_csv('ecg_data_2.csv')
...
#squaring signal
f4 = squaring(f3)
# window choosed is 18 for the sampling in this particular dataset.
window_size = 22 
f5 = win_sum(f4, window_size)
#finding the maximum value, single point lines.
#f6 = detection(f5)
